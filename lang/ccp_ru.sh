...
export MAIN_MENU3="Настроить хост"
export MAIN_MENU4="Настройки сети"
export MAIN_MENU5="Управление ресурсами хоста"
...
export CHANGE_SUCCSESS="Изменения были применены."
...
export LIKE_REBOOT_SSH="Желаете ли вы перезапустить SSH? SSH сессия может быть сброшена."
export CONFIG_HOST_MENU1="Включить или выключить вход в SSH с root"
export CONFIG_HOST_MENU2="Включить прокрутку в sceen"
export CONFIG_HOST_MENU3="Изменить root пароль"