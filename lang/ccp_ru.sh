...
export MAIN_MENU7="Управление электронной почтой"
...
export EMAIL_MANAGE_MENU3="Создать пользователя почты"
export EMAIL_MANAGE_MENU4="Удалить пользователя почты"
export EMAIL_MANAGE_MENU5="Вывести почтовые домены"
export EMAIL_MANAGE_MENU6="Вывести пользоваетелей почты"
export EMAIL_MANAGE_MENU7="Настроить DKIM"
export EMAIL_MANAGE_MENU8="Настроить SSL/TLS"
export EMAIL_MANAGE_MENU9="Настроить LDAP (AD) интеграцию (Бета функция)"
export EMAIL_MANAGE_MENU10="Поменять пароль пользователя почты"
