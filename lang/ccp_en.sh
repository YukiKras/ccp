...
export WEB_MANAGE_MENU3="Enable the site"
export WEB_MANAGE_MENU4="Turn off the site"
export WEB_MANAGE_MENU5="Restart web services"
export WEB_MANAGE_MENU6="Configure Let's Encrypt certificate (only on nginx)"
export WEB_MANAGE_MENU7="PHP management"
export WEB_MANAGE_MENU8="Manage web templates"
