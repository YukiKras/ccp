...
export LIKE_SSL="Do you want to configure SSL? (1 - Yes, 2 - No):"
export LIKE_LTSENCRYPT="Do you want to use a certificate from Let's Encrypt? (1 - Yes, 2 - No):"
...
export WEB_SITE_LISTS="List of websites:"
